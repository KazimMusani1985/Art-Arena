                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="shop.php" class="nav-item nav-link <?= $active=="shop.php"? 'active':''; ?>">Shop</a>
                            <a href="contact_us.php" class="nav-item nav-link <?= $active=="contact_us.php"? 'active':''; ?>">Contact</a>
                            <a href="" class="nav-item nav-link <?= $active=="about_us.php"? 'active':''; ?>">About Us</a>
                        </div>
